...
(defmacro defmaze (name maze)
  `(progn
     (pushnew (cons ,name ,maze) *maze-layouts*)))

(defun get-maze (name)
  (cdr (assoc name *maze-layouts*)))

(defun list-maze-names ()
  (reverse (mapcar #'car *maze-layouts* )))
;; default maze
